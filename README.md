To run this project successfully, it is important to install the libraries in the correct location (a virtual environment) rather than your computer's global system.
